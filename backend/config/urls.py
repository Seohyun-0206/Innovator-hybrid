...
from apps.catalog.views import (
    ...
    EvaluationResultArtifactsView,
    EvaluationResultListView,
    EvaluationModelAvailabilityView,
    EvaluationRunDetailView,
    EvaluationRunExecuteView,
    EvaluationRunListView,
    GeneratedDatasetDetailView,
    GeneratedDatasetGenerateView,
    GeneratedDatasetListView,
    LLMModelDetailView,
    LLMModelConnectivityView,
    LLMModelListView,
...
urlpatterns = [
    ...
    path("api/evaluation-runs/", EvaluationRunListView.as_view(), name="evaluation-runs"),
    path("api/evaluation-runs/model-availability/", EvaluationModelAvailabilityView.as_view(), name="evaluation-model-availability"),
    path("api/evaluation-runs/<int:pk>/", EvaluationRunDetailView.as_view(), name="evaluation-run-detail"),
    path("api/evaluation-runs/<int:pk>/execute/", EvaluationRunExecuteView.as_view(), name="evaluation-run-execute"),
    path("api/evaluation-results/", EvaluationResultListView.as_view(), name="evaluation-results"),
    path("api/evaluation-item-results/", EvaluationItemResultListView.as_view(), name="evaluation-item-results"),
    path("api/evaluation-results/<int:pk>/artifacts/", EvaluationResultArtifactsView.as_view(), name="evaluation-result-artifacts"),
    path("api/generated-datasets/", GeneratedDatasetListView.as_view(), name="generated-datasets"),
    path("api/generated-datasets/generate/", GeneratedDatasetGenerateView.as_view(), name="generated-dataset-generate"),
    path("api/generated-datasets/<int:pk>/", GeneratedDatasetDetailView.as_view(), name="generated-dataset-detail"),
